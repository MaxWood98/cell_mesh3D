...
%Octree options
cm3dop.nrefine = 7;              %Maximum refinement level 
...
cm3dop.fbound = 8.0;             %Far field distance from object centre  
...
cm3dop.surftype = 1;              %Geometry surface type (0 = 'simplified' | 1 = 'exact') 
